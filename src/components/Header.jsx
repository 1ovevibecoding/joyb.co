          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-8">
              <a href="#/" className="flex-shrink-0 flex items-center group">
                <img src={`${import.meta.env.BASE_URL}joyb-flame-logo.png`} alt="JoyB" className="h-10 w-auto object-contain group-hover:scale-105 transition-transform" />
              </a>
        ...
        <div className="px-6 py-4 border-b border-gray-100 dark:border-[#1e1e24] flex items-center justify-between">
          {user ? (
            ...
            <div className="flex items-center space-x-2">
              <img src={`${import.meta.env.BASE_URL}joyb-flame-logo.png`} alt="JoyB" className="h-7 w-auto" />
